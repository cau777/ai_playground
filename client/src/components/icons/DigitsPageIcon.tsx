import {IconComponent} from "~/components/icons/icon-types";

export const DigitsPageIcon: IconComponent = (props) => (
    <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
         viewBox="0 0 1280.000000 1280.000000"
         preserveAspectRatio="xMidYMid meet" {...props}>
        <g transform="translate(0.000000,1320.000000) scale(0.100000,-0.100000)"
           fill="currentColor" stroke="black" stroke-width={800} style={"paint-order: stroke"}>
...
450 405 371 712 686 1790 1836 49 53 93 97 97 98 4 0 -1 -18 -11 -41z"/>
        ...
        <text stroke="black" stroke-width={70} style={"paint-order: stroke"} x={800} y={1130} fill={"currentColor"} font-size={"400"} font-weight={"bold"}>4</text>
    </svg>
)