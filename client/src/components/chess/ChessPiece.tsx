...
export const ChessPiece: FC<Props> = (props) => {
    let side = props.notation == props.notation.toUpperCase();
    switch (props.notation.toUpperCase()) {
        case "K":
            return side
                ? (
                ...
                : (
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" width="100%" height="100%">
                        <g fill="none" fillOpacity="1" fillRule="evenodd" stroke="#000000" strokeWidth="1.5"
                           ...
                           strokeOpacity="1">
                            <path d="M 22.5,11.63 L 22.5,6" fill="none" stroke="#000" strokeLinejoin="miter"
                                  id="path6570"/>
                            <path
                                d="M 22.5,25 C 22.5,25 27,17.5 25.5,14.5 C 25.5,14.5 24.5,12 22.5,12 C 20.5,12 19.5,14.5 19.5,14.5 C 18,17.5 22.5,25 22.5,25"
                                fill="#000000" fillOpacity="1" strokeLinecap="butt" strokeLinejoin="miter"/>
                            <path
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 45 45" width="100%"
                        ...
                        <g fill="#000000" stroke="#000000" strokeWidth="1.5" strokeLinecap="round"
                           strokeLinejoin="round">
                            <path
                                d="M 9,26 C 17.5,24.5 30,24.5 36,26 L 38.5,13.5 L 31,25 L 30.7,10.9 L 25.5,24.5 L 22.5,10 L 19.5,24.5 L 14.3,10.9 L 14,25 L 6.5,13.5 L 9,26 z"
                                strokeLinecap="butt" fill="#000000"/>
                            <path
                        ...
                        <g opacity="1" fill="none" fillRule="evenodd" fillOpacity="1" stroke="#000000"
                           ...
                           strokeDasharray="none" strokeOpacity="1" transform="translate(0,0.6)">
                            ...
                            <path d="M 17.5,26 L 27.5,26 M 15,30 L 30,30 M 22.5,15.5 L 22.5,20.5 M 20,18 L 25,18"
                                  fill="none" stroke="#000000" strokeLinejoin="miter"/>
                        </g>
                    </svg>
                )
                : (
                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 45 45" width="100%">
                        <g opacity="1" fill="none" fillRule="evenodd" fillOpacity="1" stroke="#000000"
                           ...
                           strokeDasharray="none" strokeOpacity="1" transform="translate(0,0.6)">
                            ...
                            <path d="M 17.5,26 L 27.5,26 M 15,30 L 30,30 M 22.5,15.5 L 22.5,20.5 M 20,18 L 25,18"
                                  fill="none" stroke="#ffffff" strokeLinejoin="miter"/>
                        </g>
                    </svg>
                )
        case "N":
                ...
                ? (
                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 45 45" width="100%">
                        <path
                            ...
                            strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="miter" strokeMiterlimit="4"
                            strokeDasharray="none" strokeOpacity="1"/>
                    </svg>
                )
                : (
