...
export const ChessPiece: Component<Props> = (props) => {
    let side = () => props.notation == props.notation.toUpperCase();
    let notation = () => props.notation.toUpperCase();
    
    return <>
        <Show when={side()} keyed={false}>
            <Switch fallback={<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" width="100%"></svg>}>
                <Match when={notation() === "K"} keyed={false}>
                ...
                <Match when={notation() === "Q"} keyed={false}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" width="100%">
                ...
                <Match when={notation() === "R"} keyed={false}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" width="100%">
                        <g opacity="1" fill="#ffffff" fill-opacity="1" fill-rule="evenodd" stroke="#000000"
                           ...
                           transform="translate(0,0.3)">
                            ...
                            <path d="M 31,17 L 31,29.5 L 14,29.5 L 14,17" stroke-linecap="butt"
                ...
                <Match when={notation() === "B"} keyed={false}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" width="100%">
                        <g opacity="1" fill="none" fill-rule="evenodd" fill-opacity="1" stroke="#000000"
                           stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="4"
                           stroke-dasharray="none" stroke-opacity="1" transform="translate(0,0.6)">
                ...
                <Match when={notation() === "N"} keyed={false}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" width="100%">
                        <g opacity="1" fill="none" fill-opacity="1" fill-rule="evenodd" stroke="#000000"
                           stroke-width="1.5"
                           ...
                           transform="translate(0,0.3)">
                            ...
                            <path d="M 15 15.5 A 0.5 1.5 0 1 1  14,15.5 A 0.5 1.5 0 1 1  15 15.5 z"
                                  transform="matrix(0.866,0.5,-0.5,0.866,9.693,-5.173)" fill="#000000"
                                  stroke="#000000"/>
                        </g>
                    </svg>
                </Match>
                <Match when={notation() === "P"} keyed={false}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" width="100%">
                        <path
                            d="m 22.5,9 c -2.21,0 -4,1.79 -4,4 0,0.89 0.29,1.71 0.78,2.38 C 17.33,16.5 16,18.59 16,21 c 0,2.03 0.94,3.84 2.41,5.03 C 15.41,27.09 11,31.58 11,39.5 H 34 C 34,31.58 29.59,27.09 26.59,26.03 28.06,24.84 29,23.03 29,21 29,18.59 27.67,16.5 25.72,15.38 26.21,14.71 26.5,13.89 26.5,13 c 0,-2.21 -1.79,-4 -4,-4 z"
                            opacity="1" fill="#ffffff" fill-opacity="1" fill-rule="nonzero" stroke="#000000"
        ...
        <Show when={!side()} keyed={false}>
            <Switch fallback={<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" width="100%"></svg>}>
                <Match when={notation() === "K"} keyed={false}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" width="100%">
                        <g fill="none" fill-opacity="1" fill-rule="evenodd" stroke="#000000" stroke-width="1.5"
                           stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="4" stroke-dasharray="none"
                           stroke-opacity="1">
                            <path d="M 22.5,11.63 L 22.5,6" fill="none" stroke="#000" stroke-linejoin="miter"
                                  id="path6570"/>
                            <path
                ...
                <Match when={notation() === "Q"} keyed={false}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" width="100%">
                        <g fill="#000000" stroke="#000000" stroke-width="1.5" stroke-linecap="round"
                           stroke-linejoin="round">
                            <path
                                d="M 9,26 C 17.5,24.5 30,24.5 36,26 L 38.5,13.5 L 31,25 L 30.7,10.9 L 25.5,24.5 L 22.5,10 L 19.5,24.5 L 14.3,10.9 L 14,25 L 6.5,13.5 L 9,26 z"
                                stroke-linecap="butt" fill="#000000"/>
                            <path
                ...
                <Match when={notation() === "R"} keyed={false}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" width="100%">
                        <g opacity="1" fill="#000000" fill-opacity="1" fill-rule="evenodd" stroke="#000000"
                           stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="4"
                           stroke-dasharray="none" stroke-opacity="1"
                           transform="translate(0,0.3)">
                            <path d="M 9,39 L 36,39 L 36,36 L 9,36 L 9,39 z " stroke-linecap="butt"/>
                            ...
                            <path d="M 12,36 L 12,32 L 33,32 L 33,36 L 12,36 z " stroke-linecap="butt"/>
                            <path d="M 14,29.5 L 14,16.5 L 31,16.5 L 31,29.5 L 14,29.5 z " stroke-linecap="butt"
                                  stroke-linejoin="miter"/>
                        ...
                        <g opacity="1" fill="none" fill-opacity="1" fill-rule="evenodd" stroke="#000000"
                           ...
                           transform="translate(0,0.3)">
                            ...
                            <path d="M 9.5 25.5 A 0.5 0.5 0 1 1 8.5,25.5 A 0.5 0.5 0 1 1 9.5 25.5 z" fill="#ffffff"
                                  stroke="#ffffff"/>
                            <path d="M 15 15.5 A 0.5 1.5 0 1 1  14,15.5 A 0.5 1.5 0 1 1  15 15.5 z"
                                  transform="matrix(0.866,0.5,-0.5,0.866,9.693,-5.173)" fill="#ffffff"
                                  stroke="#ffffff"/>
                            <path
                ...
                <Match when={notation() === "P"} keyed={false}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" width="100%">
                        <path
                            d="m 22.5,9 c -2.21,0 -4,1.79 -4,4 0,0.89 0.29,1.71 0.78,2.38 C 17.33,16.5 16,18.59 16,21 c 0,2.03 0.94,3.84 2.41,5.03 C 15.41,27.09 11,31.58 11,39.5 H 34 C 34,31.58 29.59,27.09 26.59,26.03 28.06,24.84 29,23.03 29,21 29,18.59 27.67,16.5 25.72,15.38 26.21,14.71 26.5,13.89 26.5,13 c 0,-2.21 -1.79,-4 -4,-4 z"
                            opacity="1" fill="#000000" fill-opacity="1" fill-rule="nonzero" stroke="#000000"
                            stroke-width="1.5" stroke-linecap="round" stroke-linejoin="miter" stroke-miterlimit="4"
                            stroke-dasharray="none" stroke-opacity="1"/>
                    </svg>
                </Match>
